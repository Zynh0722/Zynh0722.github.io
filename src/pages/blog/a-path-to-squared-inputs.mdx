...
day), I will skip by implementing a swerve drive part of this process, and
instead look merely at how we control it.

### Our new Axis! {/* <!-- markdownlint-disable-line --> */}

Talk about the 3 input axis necessary for controlling a swerve drive, and what
that looks like on a gamepad
